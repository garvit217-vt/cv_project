...
if __name__ == '__main__':
    ...
    root_dir1 = "/groups/synergy_lab/garvit217/transfer/"
    trainset = CovidCTDataset(root_dir=root_dir1 + 'analysis_ai_data1/',
                              txt_COVID=root_dir1 + 'analysis_ai_data1/np_train.txt',
                              txt_NonCOVID=root_dir1 + 'analysis_ai_data1/ncp_train.txt',
                              transform= train_transformer)
    valset = CovidCTDataset(root_dir=root_dir1 + 'analysis_ai_data1/',
                              txt_COVID=root_dir1 + 'analysis_ai_data1/np_val.txt',
                              txt_NonCOVID=root_dir1 + 'analysis_ai_data1/ncp_val.txt',
                              transform= val_transformer)
    testset = CovidCTDataset(root_dir=root_dir1 + 'analysis_ai_data1/',
                              txt_COVID=root_dir1 + 'analysis_ai_data1/np_test.txt',
                              txt_NonCOVID=root_dir1 + 'analysis_ai_data1/ncp_test.txt',
                              transform= val_transformer)
#
...
decay_rate = 0.9
#scheduler = optim.lr_scheduler.ExponentialLR(optimizer=optimizer, gamma=decay_rate)
scheduler1 = optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=10)
scheduler2 = StepLR(optimizer, step_size=1)
